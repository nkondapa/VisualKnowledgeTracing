...
for d, dataset in enumerate(dataset_list):
    ...
    for feature_dimension in feature_dimensions:
        for script_name in script_names:
            _metric_summary_dict = {'script_name': script_name, 'dataset': dataset, 'feature_dimension': feature_dimension}
            _metric_data_dict = {'script_name': script_name, 'dataset': dataset, 'feature_dimension': feature_dimension}
            ...
            experiment_save_specifier = f'/{tag_name}/model={model_name}_dataset={dataset}_embdim={feature_dimension}'
            filename = 'best.pt'
