...
from observer_models.baseline import PerClassAccuracyBaseline
...
if not args.continue_training:
    if args.feature_extractor_path != 'none':
        ...
        if 'greebles' in args.experiment_data_specifier:
            ...
            fe_model = 'cnn144_1ch'
    model = PerClassAccuracyBaseline(response_dimension=(evars.num_supervised_queries, evars.num_classes),
...
optimizer = torch.optim.Adam([
    {'params': model.conditional_transform.parameters(), 'lr': args.lr},
