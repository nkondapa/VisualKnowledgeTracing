...
from observer_models.baseline import TimestepBaseline
...
if not args.continue_training:
    ...
    model = TimestepBaseline(response_dimension=(evars.num_supervised_queries, evars.num_classes),
...
optimizer = torch.optim.Adam([
    {'params': model.hyperplanes, 'lr': args.lr},
