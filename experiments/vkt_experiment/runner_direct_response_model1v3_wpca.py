...
from observer_models.lstm import LSTMObserverModelDR1v3wPCA
...
if not args.continue_training:
    ...
    model = LSTMObserverModelDR1v3wPCA(response_dimension=(evars.num_supervised_queries, evars.num_classes),
...
optimizer = torch.optim.Adam([
    ...
    {'params': model.transform_hidden_state_to_response.parameters(), 'lr': args.lr},
