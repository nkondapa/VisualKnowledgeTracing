...
from observer_models.baseline import PrototypeBaseline
...
if not args.continue_training:
    if args.feature_extractor_path != 'none':
        ...
        if 'greebles' in args.experiment_data_specifier:
            ...
            fe_model = 'cnn144_1ch'
    model = PrototypeBaseline(response_dimension=(evars.num_supervised_queries, evars.num_classes),
