...
from observer_models.lstm import LSTMObserverModelCLF1v3
...
if not args.continue_training:
    ...
    model = LSTMObserverModelCLF1v3(response_dimension=(evars.num_supervised_queries, evars.num_classes),
