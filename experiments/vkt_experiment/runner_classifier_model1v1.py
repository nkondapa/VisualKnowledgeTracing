...
from observer_models.lstm import LSTMObserverModelCLF1v1
...
if not args.continue_training:
    ...
    model = LSTMObserverModelCLF1v1(response_dimension=(evars.num_supervised_queries, evars.num_classes),
