...
from tracing_models.lstm import LSTMTracingModelDR1v3wPCA
...
if not args.continue_training:
    ...
    model = LSTMTracingModelDR1v3wPCA(response_dimension=(evars.num_supervised_queries, evars.num_classes),
